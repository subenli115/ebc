...
import com.benwunet.find.databinding.ItemFindMeetingBinding;
    ...
    extends BaseQuickAdapter<BaseCustomViewModel, BaseViewHolder>
{
    ...
    public FindMeetingAdapter(int layoutResId, Context mContext)
    {
        super(layoutResId);
        context=mContext;
    }
        ...
        @Nullable final BaseCustomViewModel baseCustomViewModel)
    {
        ...
        ItemFindMeetingBinding binding = baseViewHolder.getBinding();
        if (binding != null)
        {
