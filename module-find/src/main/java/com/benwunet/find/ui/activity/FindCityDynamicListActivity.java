...
import com.benwunet.find.databinding.ItemFindCityHeadViewBinding;
...
/**
 * @Package: com.benwunet.find.ui.activity
 * @ClassName: FindCityDynamicListActivity
 * @Description: 城市动态
 * @Author: feng
 * @CreateDate: 2020/10/20 0020 11:14
 * @Version: 1.0
 */
public class FindCityDynamicListActivity extends CommHttpActivity<ActivityFindTopicHomeBinding, FindViewModel> {
    ...
    public void initData() {
        ...
        baseBinding.ntb.setNewTitleText(getString(R.string.find_city_dynamic));
    ...
    public BaseQuickAdapter getAdapter() {
        return new FindRecommendAdapter(R.layout.item_find_recommend, this);
    }

    @Override
    public ViewBinding getHeader() {
        return ItemFindCityHeadViewBinding.inflate(LayoutInflater.from(this));
    }
