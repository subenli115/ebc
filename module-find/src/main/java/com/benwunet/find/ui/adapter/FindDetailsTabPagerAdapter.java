...
public class FindDetailsTabPagerAdapter extends FragmentPagerAdapter {
    private final Context mContext;
    private List<Fragment> fragmentList = new ArrayList<>();
    private String[] strings;

    public FindDetailsTabPagerAdapter(FragmentManager fm, Context context) {
        super(fm);
        mContext=context;
        strings = ArrayUtils.getArray(mContext, R.array.find_details_tabs);
    }
