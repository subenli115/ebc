...
/**
 * @Package: com.benwunet.find.ui.activity
 * @ClassName: FindTopicListActivity
 * @Description: 话题列表
 * @Author: feng
 * @CreateDate: 2020/10/20 0020 11:14
 * @Version: 1.0
 */
public class FindTopicListActivity extends CommHttpActivity<ActivityFindTopicHomeBinding, FindViewModel> {
    ...
    public void initData() {
        ...
        baseBinding.ntb.setNewTitleText(getString(R.string.find_topic_list));
