 ...
 * @since 2020-02-23
 */
public class FindTopicHomeAdapter
    extends BaseQuickAdapter<BaseCustomViewModel, BaseViewHolder>
{
    private final Context context;

    public FindTopicHomeAdapter(int layoutResId, Context mContext)
    {
        super(layoutResId);
        context=mContext;
    }
        ...
        @Nullable final BaseCustomViewModel baseCustomViewModel)
    {
        ...
        ItemFindHomeTopicBinding binding = baseViewHolder.getBinding();
