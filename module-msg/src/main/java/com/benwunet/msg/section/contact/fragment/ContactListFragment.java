package com.benwunet.msg.section.contact.fragment;
...
import com.benwunet.msg.common.model.ContactHeaderBean;
...
import com.benwunet.msg.section.contact.activity.ChatRoomContactManageActivity;
...
import com.benwunet.msg.section.contact.adapter.ContactHeaderAdapter;
...
import com.benwunet.msg.section.search.SearchFriendsActivity;
...
public class ContactListFragment extends EaseContactListFragment implements View.OnClickListener {
    ...
    public void onChildContextItemSelected(MenuItem item, EaseUser user) {
        ...
        if (item.getItemId() == R.id.action_friend_block) {
    ...
    public void addHeader(ConcatAdapter concatAdapter) {
        ...
        headerAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                if (item.getName() == R.string.em_friends_new_chat) {
                    AddContactActivity.startAction(mContext, SearchType.CHAT);
                } else if (item.getName() == R.string.em_friends_group_chat) {
                    GroupContactManageActivity.actionStart(mContext);
                } else if (item.getName() == R.string.em_friends_chat_room) {
