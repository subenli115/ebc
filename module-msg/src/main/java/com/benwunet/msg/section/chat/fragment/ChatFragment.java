...
import com.benwunet.msg.section.chat.activity.LiveActivity;
...
import com.benwunet.msg.section.dialog.FullEditDialogFragment;
    ...
    public void onBubbleLongClick(View v, EMMessage message) {
        ...
        menu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (itemId == R.id.action_chat_copy) {//复制
                    clipboard.setPrimaryClip(ClipData.newPlainText(null,
                            ((EMTextMessageBody) message.getBody()).getMessage()));
                } else if (itemId == R.id.action_chat_delete) {//删除
                ...
                } else if (itemId == R.id.action_chat_forward) {//分享
                    ForwardMessageActivity.actionStart(mContext, message.getMsgId());
                } else if (itemId == R.id.action_chat_recall) {//撤回
                    if (messageChangeListener != null) {
