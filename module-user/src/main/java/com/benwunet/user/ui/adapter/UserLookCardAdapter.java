...
import com.benwunet.user.databinding.ItemUserLookCardBinding;
...
public class UserLookCardAdapter
    ...
    protected void convert(@NotNull BaseViewHolder baseViewHolder,
        ...
        ItemUserLookCardBinding binding = baseViewHolder.getBinding();
        if (binding != null) {
