...
import com.benwunet.user.databinding.MoreItemPeopleViewBinding;
    ...
    extends BaseQuickAdapter<BaseCustomViewModel, BaseViewHolder>
{
    ...
    public TopicAdapter(int layoutResId, Context mContext)
    {
        super(layoutResId);
        context=mContext;
    }
        ...
        @Nullable final BaseCustomViewModel baseCustomViewModel)
    {
        ...
        MoreItemPeopleViewBinding binding = baseViewHolder.getBinding();
        if (binding != null)
        {
