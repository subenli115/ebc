...
import com.benwunet.user.databinding.ItemUserBusinessViewBinding;
...
public class UserBusinessAdapter
    ...
    protected void convert(@NotNull BaseViewHolder baseViewHolder,
        ...
        ItemUserBusinessViewBinding binding = baseViewHolder.getBinding();
        if (binding != null) {
