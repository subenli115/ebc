...
import com.benwunet.user.ui.adapter.UserLookCardAdapter;
...
/**
 * @Package: com.benwunet.user.ui.activity
 * @ClassName: UserLookCardActivity
 * @Description: 我看过的名片
 * @Author: feng
...
public class UserLookCardActivity extends BaseActivity<ActivityUserCommonBinding, BaseViewModel> {

    private static final int REQUEST_CODE_INVITE =1001 ;
    private Context mContext;
    private UserLookCardAdapter adapter;
    ...
    public void initData() {
        mContext = this;
        binding.ntb.setNewTitleText(getString(R.string.user_look_card));
        adapter = new UserLookCardAdapter(R.layout.item_user_look_card, mContext);
