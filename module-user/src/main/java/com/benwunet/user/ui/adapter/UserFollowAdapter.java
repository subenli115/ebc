...
public class UserFollowAdapter
    ...
    protected void convert(@NotNull BaseViewHolder baseViewHolder,
        ...
        ItemUserFollowViewBinding binding = baseViewHolder.getBinding();
        if (binding != null) {
            ...
            binding.ivSelect.setSelected(item.isSelect);
            binding.ivSelect.setVisibility(item.isVisible ? View.VISIBLE : View.GONE);
