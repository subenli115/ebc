...
import com.benwunet.user.databinding.ActivityUserDetailBinding;
...
public class UserBillDetailsActivity extends BaseActivity<ActivityUserDetailBinding, BaseViewModel> {
    ...
    public int initContentView(Bundle savedInstanceState) {
        return R.layout.activity_user_bill_details;
    }
