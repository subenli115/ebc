...
import com.benwunet.user.ui.adapter.UserVisitorAdapter;
...
public class UserVisitorActivity extends BaseActivity<ActivityUserCommonBinding, BaseViewModel> {
    ...
    public void initData() {
        mContext = this;
        binding.ntb.setNewTitleText(getString(R.string.user_visitor));
        adapter = new UserVisitorAdapter(R.layout.item_user_visitor_view, mContext);
